...
document.getElementById("perfumes").textContent=translations[lang].perfumes;
document.getElementById("aboutLink").textContent=translations[lang].about;
document.getElementById("contactLink").textContent=translations[lang].contact;
...
document.getElementById("brands").textContent=translations[lang].brands;
document.getElementById("why").textContent=translations[lang].why;
